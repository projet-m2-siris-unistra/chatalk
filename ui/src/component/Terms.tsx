...
const Terms: React.FC = () => {
  ...
  return (
    <div style={{ color: '#0b6374' }}>
      ...
      <p>
        The Chatalk website located at http://chatalk.fr is a copyrighted work
        belonging to ALGGOT. Certain features of the Site may be subject to
      ...
      <p>
        ...
        Chatalk uses ‘cookies’. These cookies are used to store information
      ...
      <p>
        ...
        Company should be sent to: 300 Bd Sébastien Brant, 67400
        Illkirch-Graffenstaden. After the Notice is received, you and the
      ...
      <p>
        ...
        <Link to="/Privacy" style={{ color: '#0b6374' }}>
          Privacy policy
        </Link>
        .
      </p>
