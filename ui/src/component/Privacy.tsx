...
const Privacy: React.FC = () => {
  ...
  return (
    <div style={{ color: '#0b6374' }}>
      ...
      <p>Effective date: November 18, 2019</p>

      <p>
        Chatalk ("us", "we", or "our") operates the https://chatalk.fr website
        and the Chatalk mobile application (the "Service").
      </p>
      ...
      <p>Chatalk uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        If you are located outside France and choose to provide information to
      ...
      <p>
        Chatalk will take all steps reasonably necessary to ensure that your
      ...
      <p>
        Chatalk may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Chatalk</li>
        <li>
      ...
      <ul>
        <li>By email: chatalk@gmail.com</li>
      </ul>
    </div>
  );
};
